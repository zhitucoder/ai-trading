...
python src/scripts/source/import_kline.py        # Tongdaxin .day files → daily_kline
python src/scripts/source/import_financial.py    # Tongdaxin GPCW .dat files → fin_* tables
```
