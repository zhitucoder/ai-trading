...
> 版本：v1.0 | 日期：2026-08
> 关联：`src/scripts/tools/download_reports.py`、`src/app/routers/query.py`、`src/app/routers/screening.py`、`report_pdf` 表
...
| 5 | AI 蒸馏脚本：逐公司 LLM → `stock_mda_ai`，`--workers 8 --resume` 断点续跑 | `src/scripts/compute/compute_mda_ai.py`（新） | ~1h + 几元token |
